...
author: "YPsquad: Yupeng, Cici, Jiaxi, Naomi"
date: "`r Sys.Date()`"
...
plastic_data_all %>% arrange(desc(region))
...
plastic_data_all %>% 
  mutate(
    pct_mismanaged_plastic_ocean = (100*mismanaged_plastic_ocean)/mismanaged_plastic
  ) %>% 
...
plastic_data_all %>% 
  ...
  mutate(region=case_when(region=="Latin America and The Caribbean"~"LAC"))
